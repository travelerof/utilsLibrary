...
public class MiniLoadingView extends View {
    ...
    private void initAttrs(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray array = context.obtainStyledAttributes(attrs,R.styleable.MiniLoadingView);

        mSize = array.getDimensionPixelSize(R.styleable.MiniLoadingView_size,30);
        mPaintColor = array.getColor(R.styleable.MiniLoadingView_color,Color.WHITE);
        array.recycle();
    }
